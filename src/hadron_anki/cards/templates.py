...
def render_card_shell(content: str, card_side: str) -> str:
    """Renders the shared base shell for all cards."""
    return f'<div class="card-shell {card_side}">\n{content}\n</div>'
...
def render_mass_front(display_name: str) -> str:
    ...
    return render_card_shell(content, "front")
...
def render_mass_back(spec: ParticleSpec) -> str:
    ...
    return render_card_shell(content, "back")
